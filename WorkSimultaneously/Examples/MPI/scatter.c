...
Run the program with 2, 4, 6 or 8 processes.
...
int main(int argc, char* argv[]) {
  ...
  myname[namelen++] = (char)0;               /* Add terminating null byte */
  ...
  if (me == 0) {    /* Process 0 does this */
    ...
    printf("Process %d on host %s is scattering the array x to all %d processes\n\n",
	   me, myname, np);

    /* Scatter the array x evenly to all proceses, place it in y */
